...
<div class="w-11/12 m-auto bg-white shadow sm:shadow-md md:shadow-lg lg:shadow-xl my-8 p-8">
    ...
    ?>
    <h1 class="fade-in-bottom uppercase text-red-700 text-3xl md:text-4xl lg:text-5xl font-medium">Search Results for: <?php echo get_search_query() ?></h1>
    <div class="my-8">
        <?php if(have_posts(  )) : ?>
        ...
        <?php else : ?>
            ...
            <h1 class="text-4xl uppercase text-red-700 font-light tracking-wider mt-4">Sadly we did not find what you were looking for!</h1>
        <?php endif; ?>
    </div>
</div>
