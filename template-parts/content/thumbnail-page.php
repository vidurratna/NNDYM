<?php  if(has_post_thumbnail( )): ?>
    <img data-aos="fade-up" data-aos-duration="800" data-aos-once="true" class="h-page-cover w-full object-cover transition ease-in-out duration-700" src="<?php echo get_the_post_thumbnail_url( $post, $thumbnailType ) ?>" alt="eventbanner">
<?php return; endif; ?>
