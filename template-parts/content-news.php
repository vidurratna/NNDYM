...
<div data-aos="fade-up" data-aos-duration="800" data-aos-once="true" class="bg-white w-11/12 m-auto p-8 mt-4 shadow sm:shadow-md md:shadow-lg lg:shadow-xl">
    <h1 class="text-3xl text-orange-600 uppercase font-bold">Latest in news</h1>
    ...
    ?>
        ...
        <h1 class="text-4xl uppercase text-orange-600 font-light tracking-wider mt-4">I think we ran out of news...</h1>
    <?php
        else :
    ?>
